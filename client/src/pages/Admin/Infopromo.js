...
const App = () => {
    ...
    const infoPromo = (
      ...
      <div>
        <div className="bg-white rounded-lg mb-6 flex flex-col">
          <div className="p-4">
    ...
    return (
      ...
      >
        ...
        {infoPromo(promoItems.nama_promo,promoItems.diskon,menu.gambar,menu.nama_menu,promoItems.harga_akhir,promoItems.deskripsi)}
